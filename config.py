...
# SQLALCHEMY_TRACK_MODIFICATIONS = False # Recommended: Disable tracking modifications
...
# --- Database Config (Keep as provided) ---
SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or \
                          'sqlite:///' + os.path.join(os.path.abspath(os.path.dirname(__file__)), 'app.db')
SQLALCHEMY_TRACK_MODIFICATIONS = False

# --- Gemini Config (Keep as provided) ---
...
# Check if Google keys are loaded
...
# Define the OAuth configuration settings for Google
